      ...
      <div className="group relative flex flex-col-reverse">
            ...
            <div className="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg bg-gray-100">
              ...
              <div className="flex items-end p-4">
                <button type="button" className="relative z-10 w-full rounded-md bg-white bg-opacity-75 py-2 px-4 text-sm text-gray-900 opacity-0 focus:opacity-100 group-hover:opacity-100" 
                onClick={()=>setOpen(true)}>
                  Quick View<span className="sr-only">, Basic Tee 6-Pack </span></button>
              </div>
            </div>
          </div>
