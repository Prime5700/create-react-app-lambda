...
import wlogo from "../assets/whatsapp-icon.svg";
  ...
  return (
    <footer aria-label="Site Footer" className="bg-gray-200">
      <div className="mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8">
        {scrollPosition <=100 ? (
          <a className="fixed bottom-2 right-3 h-16" href="https://api.whatsapp.com/send?phone=917011223235" target="_blank" rel="noopener noreferrer">
            <img src={wlogo} alt="Whatsapp-logo"  className="h-10 w-10"/>
            {/* <svg
          ...
          <button
            className="fixed bottom-2 scale-75 right-2"
        ...
        <div className="lg:flex lg:items-start lg:gap-8">
          <div className="text-teal-600">
            ...
            {/* <svg
              ...
              <g filter="url(#filter8_d_0_1)">
                <path
                  d="M594.722 24.5722C624.746 32.8658 651.363 49.543 671.059 72.4018L633.497 101.114C619.948 85.389 601.638 73.9168 580.985 68.2117L594.722 24.5722Z"
                  fill="black"
                />
              </g>
              <g filter="url(#filter9_d_0_1)">
                <path
                  d="M517.636 284.119C545.354 292.575 575.279 290.604 602.128 278.555C628.978 266.506 651.026 245.153 664.382 218.266L628.282 199.782C619.328 217.809 604.545 232.126 586.543 240.204C568.541 248.282 548.478 249.604 529.894 243.935L517.636 284.119Z"
                  fill="black"
                />
              </g>
              <defs>
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-2 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500">
                  ...
                  latest news and exclusive offers straight to your inbox!
                </p>
                <form className="pt-5 flex">
                  {/* <input type="email" placeholder="Enter your email" className="bg-transparent border border-gray-400 py-2 px-4 placeholder-gray-500 rounded-lg"/>
            <EnvelopeIcon  className="relative right-0 h-8 w-10"/>
            <button type="submit" className="mx-4 px-4 py-2 bg-gray-700 font-semibold text-white rounded-md">Submit</button> */}
                  <div className="flex relative  w-full">
                    <input
                      type="email"
                      className="bg-transparent border border-gray-300  rounded-lg py-2 px-4"
                      placeholder="Enter your email"
                    />
                    <button className="bg-blue-700 hover:bg-blue-900 mx-5 text-white font-bold rounded-lg py-2 px-5">
                      Subscribe
                    </button>
                  </div>
                </form>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; {date}. Company Name. All rights reserved.
            </p>
