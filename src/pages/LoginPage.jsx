    ...
    <div className="h-full bg-gray-100 w-full py-20 bg-fixed  px-4">
      <div className="flex flex-col items-center  justify-center">
        ...
        <div className="bg-white shadow rounded lg:w-1/3 mt-5 md:w-2/3 w-full z-10 p-10 ">
          ...
          <form onSubmit={HandeSubmit} ref={form}>
            {/* email input  */}
            <div>
              <label htmlFor="email-box" className="text-sm font-medium leading-none text-gray-800">
                Email
              </label>
              <input
            ...
            <div className="mt-6  w-full">
              <label htmlFor="password-box" className="text-sm font-medium leading-none text-gray-800">
                Password
              </label>
            ...
            <Link to="/auth/reset-password" className="text-blue-800 underline pt-2">
              Forgot password?
            </Link>
            {/* continue button  */}
            <div className="mt-8">
              <button
                ...
                className="focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 text-sm font-semibold leading-none text-white focus:outline-none bg-gray-900 border rounded-md hover:bg-black py-4 w-full"
              >
                Continue
